...
import com.basistech.rosette.dm.AdmAssert;
...
/**
 * Test that the OSGi apparatus works.
 */
@RunWith(PaxExam.class)
@ExamReactorStrategy(PerClass.class)
public class JsonFragmentIT extends AdmAssert {
    ...
    public Option[] config() {
        ...
        return options(
                provision(bundles),
                // this is a fragment, don't start it.
                url(String.format("file:%s/adm-json-%s.jar", projectBuildDirectory, projectVersion)).noStart(),
                systemPackages(
