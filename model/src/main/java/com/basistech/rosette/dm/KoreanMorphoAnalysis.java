...
public class KoreanMorphoAnalysis extends MorphoAnalysis {
    ...
    KoreanMorphoAnalysis(String partOfSpeech,
                         String lemma,
        ...
        if (morphemeTags != null) {
            this.morphemeTags = ImmutableList.copyOf(morphemeTags);
        } else {
            this.morphemeTags = null;
        }
    }

    protected KoreanMorphoAnalysis() {
        morphemes = ImmutableList.of();
        morphemeTags = ImmutableList.of();
    }
    ...
    public static class Builder extends MorphoAnalysis.Builder {
        ...
        public KoreanMorphoAnalysis build() {
            return new KoreanMorphoAnalysis(partOfSpeech, lemma, listOrNull(components), raw, listOrNull(morphemes), listOrNull(morphemeTags), extendedProperties);
        }
    }
}
